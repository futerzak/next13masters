 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CartUpsertItem($cartId: ID!, $productId: ID!, $total: Int!, $orderItemId: ID, $quantity: Int) {\n  upsertOrderItem(\n    where: {id: $orderItemId}\n    upsert: {create: {quantity: 1, total: $total, order: {connect: {id: $cartId}}, product: {connect: {id: $productId}}}, update: {quantity: $quantity, total: $total}}\n  ) {\n    id\n  }\n}"): typeof import('./graphql').CartUpsertItemDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetOrderItemsByOrderIdAndProductId($cartId: ID!, $productId: ID!) {\n  orderItems(where: {order: {id: $cartId}, AND: {product: {id: $productId}}}) {\n    id\n  }\n}"): typeof import('./graphql').GetOrderItemsByOrderIdAndProductIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ReviewCreate($headline: String!, $name: String!, $email: String!, $rating: Int!, $content: String!, $productId: ID!) {\n  createReview(\n    data: {headline: $headline, name: $name, email: $email, rating: $rating, content: $content, product: {connect: {id: $productId}}}\n  ) {\n    id\n  }\n}"): typeof import('./graphql').ReviewCreateDocument;
